...
// Hash table sie directly affects on the number of collisions.
// The bigger the hash table size the less collisions you'll get.
// For demonstrating purposes hash table sie is small to show how collisions
// are being handles.
...
export default class HashTable {
  ...
  hash(key) {
    ...
    // hash = charCodeAt(0) * PRIMR^(n-1) + charCodeAt(1) * PRIME^(n-2) + .... + charCodeAt(n-1)
    ...
    // Reduce hash number so it would fit hash table sie.
